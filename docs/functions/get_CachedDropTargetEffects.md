...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomationdroptargetpattern-get_cacheddroptargeteffects)

# IUIAutomationDropTargetPattern::get\_CachedDropTargetEffects method (uiautomationclient.h)
...
```
HRESULT get_CachedDropTargetEffects(
  SAFEARRAY **retVal
);
```
