...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomation6-put_coalesceevents)

# IUIAutomation6::put\_CoalesceEvents method (uiautomationclient.h)
...
```
HRESULT put_CoalesceEvents(
  [out] CoalesceEventsOptions coalesceEventsOptions
);
```

## Parameters

`[out] coalesceEventsOptions`
