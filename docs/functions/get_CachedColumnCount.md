...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomationgridpattern-get_cachedcolumncount)

# IUIAutomationGridPattern::get\_CachedColumnCount method (uiautomationclient.h)
