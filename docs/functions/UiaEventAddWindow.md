...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationcoreapi/nf-uiautomationcoreapi-uiaeventaddwindow)

# UiaEventAddWindow function (uiautomationcoreapi.h)
