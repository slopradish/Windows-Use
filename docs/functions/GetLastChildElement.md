...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomationtreewalker-getlastchildelement)

# IUIAutomationTreeWalker::GetLastChildElement method (uiautomationclient.h)
