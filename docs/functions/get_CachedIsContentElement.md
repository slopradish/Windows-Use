...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomationelement-get_cachediscontentelement)

# IUIAutomationElement::get\_CachedIsContentElement method (uiautomationclient.h)
...
```
HRESULT get_CachedIsContentElement(
  BOOL *retVal
);
```
...
[CachedIsControlElement](/en-us/windows/desktop/api/uiautomationclient/nf-uiautomationclient-iuiautomationelement-get_cachediscontrolelement)

[CurrentIsContentElement](/en-us/windows/desktop/api/uiautomationclient/nf-uiautomationclient-iuiautomationelement-get_currentiscontentelement)
