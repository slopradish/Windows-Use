...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_role)

# ILegacyIAccessibleProvider::get\_Role method (uiautomationcore.h)
