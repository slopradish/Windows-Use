...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/oleacc/nf-oleacc-createstdaccessibleproxyw)

# CreateStdAccessibleProxyW function (oleacc.h)
