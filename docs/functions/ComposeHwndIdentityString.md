...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/oleacc/nf-oleacc-iaccpropservices-composehwndidentitystring)

# IAccPropServices::ComposeHwndIdentityString method (oleacc.h)
...
Returns E\_INVALIDARG if *hwnd*, *idObject*, or *idChild* is not valid.
