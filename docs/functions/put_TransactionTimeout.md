...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomation2-put_transactiontimeout)

# IUIAutomation2::put\_TransactionTimeout method (uiautomationclient.h)
...
```
HRESULT put_TransactionTimeout(
  [in] DWORD timeout
);
```
