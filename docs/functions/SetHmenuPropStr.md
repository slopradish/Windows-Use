...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/oleacc/nf-oleacc-iaccpropservices-sethmenupropstr)

# IAccPropServices::SetHmenuPropStr method (oleacc.h)

This method wraps [SetPropValue](/en-us/windows/desktop/api/oleacc/nf-oleacc-iaccpropservices-setpropvalue), providing a more convenient entry point for callers who are annotating **HMENU**-based accessible elements.
