...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomationstylespattern-get_currentstylename)

# IUIAutomationStylesPattern::get\_CurrentStyleName method (uiautomationclient.h)
