...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomationscrollpattern-get_currentverticallyscrollable)

# IUIAutomationScrollPattern::get\_CurrentVerticallyScrollable method (uiautomationclient.h)
...
```
HRESULT get_CurrentVerticallyScrollable(
  BOOL *retVal
);
```
...
[IUIAutomationScrollPattern::CurrentHorizontallyScrollable](/en-us/windows/desktop/api/uiautomationclient/nf-uiautomationclient-iuiautomationscrollpattern-get_currenthorizontallyscrollable)
