...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomation-removestructurechangedeventhandler)

# IUIAutomation::RemoveStructureChangedEventHandler method (uiautomationclient.h)
...
Type: **[IUIAutomationStructureChangedEventHandler](/en-us/windows/desktop/api/uiautomationclient/nn-uiautomationclient-iuiautomationstructurechangedeventhandler)\***

A pointer to the interface that was passed to [IUIAutomation::AddStructureChangedEventHandler](/en-us/windows/desktop/api/uiautomationclient/nf-uiautomationclient-iuiautomation-addstructurechangedeventhandler).
