...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-getiaccessible)

# ILegacyIAccessibleProvider::GetIAccessible method (uiautomationcore.h)

Retrieves an accessible object that corresponds to a UI Automation element that supports the [LegacyIAccessible](/en-us/windows/desktop/WinAuto/uiauto-implementinglegacyiaccessible) control pattern.
...
[ILegacyIAccessibleProvider](/en-us/windows/desktop/api/uiautomationcore/nn-uiautomationcore-ilegacyiaccessibleprovider)
