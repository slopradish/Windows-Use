...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_state)

# ILegacyIAccessibleProvider::get\_State method (uiautomationcore.h)
