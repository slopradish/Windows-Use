...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomation2-put_autosetfocus)

# IUIAutomation2::put\_AutoSetFocus method (uiautomationclient.h)
