...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomationelement-get_cachedariaproperties)

# IUIAutomationElement::get\_CachedAriaProperties method (uiautomationclient.h)
...
```
HRESULT get_CachedAriaProperties(
  BSTR *retVal
);
```
...
[CurrentAriaProperties](/en-us/windows/desktop/api/uiautomationclient/nf-uiautomationclient-iuiautomationelement-get_currentariaproperties)
