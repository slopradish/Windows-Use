...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_help)

# ILegacyIAccessibleProvider::get\_Help method (uiautomationcore.h)
