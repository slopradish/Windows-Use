...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/oleacc/nf-oleacc-iaccpropservices-sethwndprop)

# IAccPropServices::SetHwndProp method (oleacc.h)

This method wraps [SetPropValue](/en-us/windows/desktop/api/oleacc/nf-oleacc-iaccpropservices-setpropvalue), providing a convenient entry point for callers who are annotating **HWND**-based accessible elements. If the new value is a string, you can use [IAccPropServices::SetHwndPropStr](/en-us/windows/desktop/api/oleacc/nf-oleacc-iaccpropservices-sethwndpropstr) instead.
...
Returns E\_INVALIDARG if the *idProp* property is not supported.
