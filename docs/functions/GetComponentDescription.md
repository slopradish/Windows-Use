...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/msaatext/nf-msaatext-iversioninfo-getcomponentdescription)

# IVersionInfo::GetComponentDescription method (msaatext.h)
