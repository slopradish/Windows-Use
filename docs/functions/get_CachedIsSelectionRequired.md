...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomationselectionpattern-get_cachedisselectionrequired)

# IUIAutomationSelectionPattern::get\_CachedIsSelectionRequired method (uiautomationclient.h)
...
```
HRESULT get_CachedIsSelectionRequired(
  BOOL *retVal
);
```
