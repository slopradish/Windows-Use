...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/uiautomationclient/nf-uiautomationclient-iuiautomation-get_contentviewwalker)

# IUIAutomation::get\_ContentViewWalker method (uiautomationclient.h)

Retrieves an [IUIAutomationTreeWalker](/en-us/windows/desktop/api/uiautomationclient/nn-uiautomationclient-iuiautomationtreewalker) interface used to discover content elements.
