...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/msaatext/nf-msaatext-iversioninfo-getsubcomponentcount)

# IVersionInfo::GetSubcomponentCount method (msaatext.h)
