...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/msaatext/nf-msaatext-iaccclientdocmgr-lookupbyhwnd)

# IAccClientDocMgr::LookupByHWND method (msaatext.h)
...
| Error | Description |
| --- | --- |
| **E\_FAIL** | If the **HWND** does not correspond to an active document, then *ppunk* will be **NULL**. |
