...
[Original Documentation](https://learn.microsoft.com/en-us/windows/win32/api/winuser/ns-winuser-highcontrastw)

# HIGHCONTRASTW structure (winuser.h)
...
[SystemParametersInfoW function](nf-winuser-systemparametersinfow), [HIGHCONTRASTA structure](ns-winuser-highcontrasta), [Accessibility Structures](/en-us/windows/desktop/WinAuto/accessibility-structures),
