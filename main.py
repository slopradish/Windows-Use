...
def main():
    ...
    # llm=ChatOpenRouter(reasoning_effort='minimal',model="nvidia/nemotron-3-nano-30b-a3b:free",temperature=0.2)
    ...
    agent = Agent(mode='flash',llm=llm, browser=Browser.EDGE, use_vision=False,use_annotation=False, auto_minimize=False)
