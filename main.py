...
def main():
    ...
    llm=ChatGoogle(reasoning_effort='none',model="gemini-3-flash-preview",thinking_budget=0, temperature=0.7)
    ...
    agent = Agent(mode='normal',llm=llm, browser=Browser.EDGE, use_vision=False,use_annotation=False, auto_minimize=False)
